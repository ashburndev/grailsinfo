I have installed the Oracle Java JDK 8 on my Dell XPS15 laptop a number of times (various versions), and apparently Oracle Java JDK 9.0.4 and 10.0.1 as well -- all using 
